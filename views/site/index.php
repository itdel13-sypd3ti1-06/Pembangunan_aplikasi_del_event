                ...
                <section id="ccr-left-section" class="col-md-8">
                    ...
                    <div class="ccr-last-update">
                        ...
                        <div class="update-news-text" id="update-news-text">
                            <ul id="latestUpdate">  
                                <li><a href="#">Various events in IT Del</a></li>
                                <li><a href="#">Two</a></li>
                        ...
                        <div class="carousel-inner">
                            <div class="active item">
                                <div class="container slide-element">
                                    <img src="img/slide/foto1new.jpg" alt="Main Slide Image 1">
                                    <p><a href="#">Acara Last Party</a></p>
                                </div> <!-- /.slide-element -->
                            </div> <!--/.active /.item -->

                            <div class="item">
                                <div class="container slide-element">
                                    <img src="img/slide/foto2new.jpg" alt="Main Slide Image 1">
                                    <p><a href="#">Acara Satu</a></p>
                                </div> <!-- /.slide-element -->
                            </div> <!--  /.item -->

                            <div class="item">
                                <div class="container slide-element">
                                    <img src="img/slide/foto7new.jpg" alt="Main Slide Image 1">
                                    <p><a href="#">Acara Pelantikan Panitia PCA</a></p>
                                </div> <!-- /.slide-element -->
                            </div> <!-- .item -->

                            <div class="item">
                                <div class="container slide-element">
                                    <img src="img/slide/foto4new.jpg" alt="Main Slide Image 1">
                                    <p><a href="#">Acara Del Language Club</a></p>
                                </div> <!-- /.slide-element -->
                            </div> <!-- /.item -->
                    ...
                    <section id="ccr-world-news">
                        ...
                        <section class="featured-world-news">
                            ...
                            <div class="featured-world-news-post">
                                <h5>Acara Satu</h5>
                                Acara ini diselenggarakan olek Badan Pengurus Harian Keluarga Mahasiswa, sebagai bentuk penyambuan terhadap mahasiswa baru, acara ini deimerihakan dengan berbagai game dan hiburan ....
                            ...
                            <div class="featured-world-news-post">
                                <h5>Festival Band Rohani</h5>
                                Festival Band Roahani merupakan acara yang dilaksanakan oleh seksi kerohanian dalam rangka menguji kreativitas mahaiswa/i dalam menyanyikan lagu-lagu rohani ...
                                <div class="like-comment-readmore">
                                    <!--<i class="fa fa-thumbs-o-up"> 08</i>-->
                                    <a href="#" class="comments"><i class="fa fa-comments-o"></i> 20</a>
                                    <a class="read-more" href="#">Read More</a>
                                </div> <!-- /.like-comment-readmore -->
                            </div>
                            ...
                            <div class="featured-world-news-post">
                                <h5>Last Party</h5>
                                Last Party adalah acara yang diselenggarakan oleh Badan Pengurus Harian Keluarga Mahasiswa sebagai bentuk perpisahaan kepengurusan yang lama dengan mahasiswa/i ...
                                <div class="like-comment-readmore">
                                    <!--<i class="fa fa-thumbs-o-up"> 08</i>-->
                                    <a href="#" class="comments"><i class="fa fa-comments-o"></i> 11</a>
                                    <a class="read-more" href="#">Read More</a>
                                </div> <!-- /.like-comment-readmore -->
                            </div>
                            ...
                            <div class="featured-world-news-post">
                                <h5>KM Cup</h5>
                                Acara ini diselenggarakan oleh seksi oleh raga, acara ini merupakan kompetisi di bidang oleh raga yang diselrnggarakan oleh mahasiswa/i ...
                                <div class="like-comment-readmore">
                                    <!--<i class="fa fa-thumbs-o-up"> 08</i>-->
                                    <a href="#" class="comments"><i class="fa fa-comments-o"></i> 80</a>
                                    <a class="read-more" href="#">Read More</a>
                                </div> <!-- /.like-comment-readmore -->
                            </div>
                            ...
                            <div class="featured-world-news-post">
                                <h5>Kuliah Umum</h5>
                                Kuliah umum dari Bapak Ainun tentang Data Mining berlokasi di Auditorium IT Del, semua  mahasiswa diharapkan hadir ...
                                <div class="like-comment-readmore">
                                    <!--<i class="fa fa-thumbs-o-up"> 08</i>-->
                                    <a href="#" class="comments"><i class="fa fa-comments-o"></i> 80</a>
                                    <a class="read-more" href="#">Read More</a>
                    ...
                    <section id="ccr-sports-gallery">
                        ...
                        <section class="featured-sports-news">
                            <div class="featured-sports-newss-img"><img src="img/slide/foto5new.jpg" alt="Thumb"></div>
                            <div class="featured-sports-newss-post"><img src="img/slide/foto6new.jpg" alt="Thumb"></div>
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="ccr-thumbnail">
                                    <img src="img/slide/foto8new.jpg">
                                    <!--<p><a href="#postlink">Read More</a></p>-->
                                </div>
...
<!--                    <section id="sidebar-popular-post">
                        <div class="ccr-gallery-ttile">
                            <span></span> 
                            <p><strong>Categories of Event</strong></p>
                        </div>  .ccr-gallery-ttile 
                        <ul>
                            <li>
                                <img src="img/sports-thumb-1.jpg" alt="Avatar">
                                <a href="category-1.html">Sport</a>
                            ...
                            <li>
                                <img src="img/education.jpg" alt="Avatar">
                                <a href="category-2.html">Education</a>
                                						<div class="date-like-comment">
                                                                                        <span class="date"><time datetime="2014-02-17">2014-02-17</time></span>
                                                                                        <a class="like" href="#"><i class="fa fa-thumbs-o-up"></i> 08</a>
                                                                                        <a class="comments" href="#"><i class="fa fa-comments-o"></i> 49</a>
                            ...
                            <li>
                                <img src="img/spirit.jpg"" alt="Avatar">
                                <a href="category-3.html">Spirituality</a>
                                						<div class="date-like-comment">
                                                                                        <span class="date"><time datetime="2014-02-17">2014-02-17</time></span>
                                                                                        <a class="like" href="#"><i class="fa fa-thumbs-o-up"></i> 08</a>
                                                                                        <a class="comments" href="#"><i class="fa fa-comments-o"></i> 49</a>
                            ...
                            <li>
                                <img src="img/enter.jpg" alt="Avatar">
                                <a href="category-4.html">Entertainment</a>
                                						<div class="date-like-comment">
                                                                                        <span class="date"><time datetime="2014-02-17">2014-02-17</time></span>
                                                                                        <a class="like" href="#"><i class="fa fa-thumbs-o-up"></i> 08</a>
                                                                                        <a class="comments" href="#"><i class="fa fa-comments-o"></i> 49</a>
                            ...
                            <li>
                                <img src="img/music.jpg" alt="Avatar">
                                <a href="category-5.html">Music</a>
                                						<div class="date-like-comment">
                                                                                        <span class="date"><time datetime="2014-02-17">2014-02-17</time></span>
                                                                                        <a class="like" href="#"><i class="fa fa-thumbs-o-up"></i> 08</a>
                                                                                        <a class="comments" href="#"><i class="fa fa-comments-o"></i> 49</a>
                            ...
                            <li>
                                <img src="img/workshop.jpg" alt="Avatar">
                                <a href="category-6.html">Workshop</a>
                                						<div class="date-like-comment">
                                                                                        <span class="date"><time datetime="2014-02-17">2014-02-17</time></span>
                                                                                        <a class="like" href="#"><i class="fa fa-thumbs-o-up"></i> 08</a>
                                                                                        <a class="comments" href="#"><i class="fa fa-comments-o"></i> 49</a>
                            ...
                            <li>
                                <img src="img/slide/slide3.jpg" alt="Avatar">
                                <a href="category-7.html">Public Lecture</a>
                                						<div class="date-like-comment">
                                                                                        <span class="date"><time datetime="2014-02-17">2014-02-17</time></span>
                                                                                        <a class="like" href="#"><i class="fa fa-thumbs-o-up"></i> 08</a>
                                                                                        <a class="comments" href="#"><i class="fa fa-comments-o"></i> 49</a>
